    ...
    <div className="min-h-screen bg-background px-4 py-6 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between mb-8">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:gap-6">
            ...
            <div className="space-y-1">
              <h1 className="text-2xl sm:text-3xl font-bold text-secondary" data-testid="dashboard-title">Dashboard</h1>
        ...
        <div className="mt-8 flex justify-center px-4">
          <div className="w-full max-w-md bg-white rounded-xl shadow-sm border border-border p-6 text-center space-y-1">
            <p className="text-xs sm:text-sm text-muted-foreground">Powered by</p>
            <p className="text-base sm:text-lg font-semibold text-primary">Inwora IT solutions</p>
